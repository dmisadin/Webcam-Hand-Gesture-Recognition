...
def parse_opts():
    ...
    parser.add_argument('--lr_steps', default=[5, 10, 20, 45, 60, 50, 200, 250], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10') #[15, 25, 35, 45, 60, 50, 200, 250]
...
def parse_opts_online():
    ...
    parser.add_argument('--root_path', default='/root/data/ActivityNet', type=str, help='Root directory path of data')
    parser.add_argument('--video_path', default='video_kinetics_jpg', type=str, help='Directory path of Videos')
    parser.add_argument('--video', default='datasets/nvgesture/Video_data/class_03/subject2_r2/sk_color.avi', type=str, help='Directory path of test Videos')
